...
export const QAboutButtons = qwikify$(
  () => (
    <WvButtonGroup center>
      <WvButton
        onClick={() => {
          window.location.href =
            "https://docs.google.com/spreadsheets/d/1HRivx7G_Qeuk8rbomANrCSqeevaah68G51k859fA6OY/edit?usp=sharing";
        }}
      >
        <svg
          width="21"
      ...
      <WvButton
        onClick={() => {
          window.location.href = "https://bit.ly/wevisfeedback";
        }}
      >
        <img
