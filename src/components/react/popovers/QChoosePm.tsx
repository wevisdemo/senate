...
const ChoosePmContent = ({ close }: { close?: boolean }) => (
  <>
    ...
    <div className="px-15 py-10">
      ...
      <p className="wv-h9 mb-10 font-kondolar">การลงมติเลือกนายกรัฐมนตรีไทย พ.ศ. 2562</p>
...
export const QChoosePm = qwikify$(
  () => (
    <Popover className="relative flex">
      ...
      <Transition
        className="fixed left-1/2 top-1/2 z-10 -translate-x-1/2 -translate-y-1/2 transition-all lg:absolute lg:left-0 lg:top-0 lg:origin-top-left lg:translate-x-0 lg:translate-y-0"
        enterFrom="opacity-0"
