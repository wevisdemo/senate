...
export const Ch1Infinity = component$(() => {
  ...
  return (
    <div
      ref={elContainer}
      class="mb-60 flex flex-col items-center gap-10 overflow-hidden py-40"
    >
      <svg
      ...
      >
        ...
        />
        <p class="wv-h8 font-kondolar font-bold">
          &ldquo;ส.ว. ชุดใหม่&rdquo; ที่ผ่านการคัดเลือก อาจมาจากการ &ldquo;จัดฮั้ว&rdquo;
          เพื่อให้ คสช. สามารถสืบทอดอำนาจต่อไป
        </p>
      </div>
      <img
        src="./imgs/darr.svg"
